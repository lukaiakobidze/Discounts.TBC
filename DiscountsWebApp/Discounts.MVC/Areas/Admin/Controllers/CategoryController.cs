...
namespace Discounts.MVC.Areas.Admin.Controllers
{
    ...
    public class CategoryController : Controller
    {
        ...
        public async Task<IActionResult> Create(CategoryViewModel model)
        {
            ...
            await _sender.Send(new CreateCategoryCommand(model.Name, model.Description)).ConfigureAwait(false);
        ...
        {
            var category = await _sender.Send(new GetCategoryByIdQuery(id)).ConfigureAwait(false);
        ...
        public async Task<IActionResult> Edit(CategoryViewModel model)
        {
            ...
            await _sender.Send(new UpdateCategoryCommand(model.Id!.Value, model.Name, model.Description)).ConfigureAwait(false);
